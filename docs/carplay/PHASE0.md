...
2. "**Tell Fin to** restart the daemon." → Siri: "What should I tell Fin?" if the trailing text was not captured → dictate the instruction. Expect a short confirmation; no answer is read back.
...
4. Press the voice button: "**Tell Fin to** say hello in the transcript." Confirm
