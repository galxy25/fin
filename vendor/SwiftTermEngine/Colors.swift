...
public class STColor: Hashable {
    ...
    // Kept internal: these are shared, mutable STColor instances that Terminal
    ...
    public static let paleColors: [STColor] = [
        // dark colors
    ...
    public static let vgaColors: [STColor] = [
        // dark colors
    ...
    public static let terminalAppColors: [STColor] = [
        STColor (red8: 0, green8: 0, blue8: 0),
    ...
    public static let xtermColors: [STColor] = [
        STColor (red8: 0, green8: 0, blue8: 0),
    ...
    public static let defaultInstalledColors: [STColor] = [
        STColor (red8: 0, green8: 0, blue8: 0),
    ...
    static func setupDefaultAnsiColors(initialColors: [STColor],
                                       strategy: Ansi256PaletteStrategy = .xterm,
                                       backgroundColor: STColor? = nil,
                                       foregroundColor: STColor? = nil) -> [STColor]
    {
        switch strategy {
        case .xterm:
    ...
    private static func generateXtermPalette(initialColors: [STColor]) -> [STColor] {
    ...
    private static func generateBase16LabPalette(initialColors: [STColor],
                                                  backgroundColor: STColor?,
                                                  foregroundColor: STColor?,
                                                  harmonious: Bool) -> [STColor] {
    ...
    private struct LabColor {
        ...
        static func fromColor(_ color: STColor) -> LabColor {
        ...
        func toColor() -> STColor {
            ...
            return STColor(red8: Self.quantizedComponent(r),
    ...
    public static func parse (_ spec: String) -> STColor?
    {
