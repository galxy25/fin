        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    Text("To hear Fin in the car: Settings > Notifications > Announce Notifications — turn it on, turn on CarPlay, then scroll to the app list and turn on Fin. Every app is off there until you switch it on.")
                        .font(.footnote)
                } header: {
                    Text("In the car")
                }
