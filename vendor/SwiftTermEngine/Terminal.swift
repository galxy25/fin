...
public protocol TerminalDelegate: AnyObject {
     ...
     */
    func setCursorColor (source: Terminal, color: STColor?)
...
open class Terminal {
    ...
    public var cursorColor: STColor? = nil {
        didSet {
    ...
    {
        installedColors = STColor.terminalAppColors
        defaultAnsiColors = STColor.setupDefaultAnsiColors(initialColors: installedColors,
                                                         strategy: options.ansi256PaletteStrategy,
                                                         backgroundColor: STColor.defaultBackground,
                                                         foregroundColor: STColor.defaultForeground)
...
//    }
    ...
    func reportColor (oscCode: Int, color: STColor) {
    ...
    func oscSetColors (_ data: ArraySlice<UInt8>, startAt: Int)
    {
        ...
        for (offset, text) in groups.enumerated() {
            ...
            guard let color = STColor.parseColor(text) else {
                continue
            }
            switch target {
            case 0:
    ...
    {
        if let cursorColor = STColor.parseColor(data) {
