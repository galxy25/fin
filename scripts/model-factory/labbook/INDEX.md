...
| [O002](year-1/O002-2026-09-06-stale-champion.md) | 2026-09-06 | OBSERVATION | The recorded champion is a round-0 number — the gate would promote a candidate 13 points worse than the base model | standing |
| [O003](year-1/O003-2026-09-06-three-prompts-no-parity.md) | 2026-09-06 | OBSERVATION | Three router prompts exist in three places, one of them never scored, with no parity test | standing |
| [O004](year-1/O004-2026-09-06-late-run-loss-excursion.md) | 2026-09-06 | OBSERVATION | A 160x training-loss excursion in epoch 2, with no per-example log to explain it | standing |
...
| H001 | a `score_bits.py` pass over `datasets/mlx/train.jsonl` under base and adapter |
